...
CREATE INDEX IF NOT EXISTS inventorio_traslado_linea_traslado_idx ON inventario_traslado_linea(traslado_id);
CREATE INDEX IF NOT EXISTS inventorio_traslado_linea_producto_idx ON inventario_traslado_linea(producto_id);
