    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {items.map((item) => (
          <div
            key={item.id}
            className="bg-white dark:!bg-slate-900 rounded-lg shadow-sm border border-slate-100 dark:!border-slate-800 p-4 hover:shadow-md hover:border-[rgb(37,99,235)] hover:border-opacity-30 transition-shadow duration-200 transition-[border-color] duration-200 group"
          >
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-1">
                <button
                  ...
                  className="p-1.5 text-gray-400 dark:!text-slate-500 hover:text-[rgb(37,99,235)] hover:bg-[rgb(37,99,235)] hover:bg-opacity-10 rounded-lg transition-colors duration-200"
                  title="Editar"
                >
                ...
                <button
                  ...
                  className="p-1.5 text-gray-400 dark:!text-slate-500 hover:text-red-500 dark:hover:!text-red-400 hover:bg-red-50 dark:hover:!bg-red-900 dark:hover:!bg-opacity-20 rounded-lg transition-colors duration-200"
                  title="Eliminar"
                >
  ...
  return (
    <div className="relative w-full">
      ...
      <div className="flex flex-wrap gap-2 mb-8 border-b border-slate-200 dark:!border-slate-800 pb-1 transition-colors duration-200">
        {tabs.map((tab) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2.5 font-medium rounded-t-lg transition-colors duration-200 text-sm ${
              activeTab === tab.id
      ...
      <div className="space-y-6">
        ...
        {showCreateForm && (
          <div className="bg-slate-50 dark:!bg-slate-800/50 rounded-xl border border-slate-200 dark:!border-slate-700 p-6 transition-colors duration-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 border border-slate-200 dark:!border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(37,99,235)] focus:border-transparent transition-colors duration-200 text-sm bg-white dark:!bg-slate-800 text-slate-900 dark:!text-slate-100"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2.5 border border-slate-200 dark:!border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[rgb(37,99,235)] focus:border-transparent transition-colors duration-200 resize-none text-sm bg-white dark:!bg-slate-800 text-slate-900 dark:!text-slate-100"
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button
                  type="button"
                  onClick={() => setShowCreateForm(false)}
                  className="flex items-center gap-2 px-4 py-2.5 bg-slate-100 dark:!bg-slate-800 text-slate-700 dark:!text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:!bg-slate-700 transition-colors duration-200 text-sm font-medium"
                >
                ...
                <button
                  type="submit"
                  className="flex items-center gap-2 px-4 py-2.5 bg-[rgb(37,99,235)] hover:bg-[rgb(29,78,216)] text-white rounded-lg shadow hover:shadow-md transition-colors duration-200 text-sm font-medium"
                >
        ...
        {activeTab !== 'tienda' && (
          <div className="bg-slate-50 dark:!bg-slate-800/50 rounded-xl border border-slate-200 dark:!border-slate-700 relative transition-colors duration-200">
            {/* Botón de crear flotante */}
            <button
              onClick={handleCreate}
              className="absolute top-4 right-4 flex items-center justify-center w-10 h-10 bg-[rgb(37,99,235)] hover:bg-[rgb(29,78,216)] text-white rounded-lg shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-colors duration-200 transition-transform duration-200 z-10"
