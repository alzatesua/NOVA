...
export default function BodegasModal({
  ...
  return (
    <Modal onClose={onClose}>
      ...
      <div className="relative z-10 flex flex-col w-full h-full" style={{
        height: '100%'
      }}>
        ...
        <div className="md:hidden relative z-[100] flex-shrink-0 flex items-center justify-center py-2.5 sm:py-3 px-2 gap-2 w-full" style={{
          backgroundColor: 'rgba(7, 7, 7, 0)',
          borderBottom: '2px solid #0000000',
          minHeight: 'clamp(3rem, 9vw, 4rem)',
          maxHeight: 'clamp(3.5rem, 10vw, 4.5rem)',
          marginTop: '85px'
        }}>
        ...
        <div className="flex flex-1 overflow-visible flex-col md:flex-row w-full h-full">
          ...
          <div className="flex-1 flex flex-col relative overflow-hidden w-full max-w-full h-full" style={{ backgroundColor: '#0B0D26' }}>
            {/* Header más compacto en móvil */}
            <div className="relative z-10 flex-shrink-0 px-0 sm:px-0 md:px-0 pt-1.5 sm:pt-2 md:pt-2 pb-1 sm:pb-1 md:pb-1 w-full">
            ...
            <div className="flex-1 relative overflow-y-auto overflow-x-hidden w-full h-full">
              <div className="h-full px-0 sm:px-0 md:px-0 lg:px-0 pt-2 sm:pt-1 md:pt-2 lg:pt-2 pb-1 sm:pb-1 md:pb-1 lg:pb-2 w-full">
