...
export default function CrearBodega({ bodegaForm, setBodegaForm, bodegaLoading, onCrearBodega, onClose }) {
  return (
    <div className="rounded-xl p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 border w-full max-w-none" style={{
      ...
      <form onSubmit={onCrearBodega} className="flex flex-col gap-3 sm:gap-3.5 md:gap-4 lg:gap-5 w-full">
        <div className="w-full">
          <label className="block text-xs sm:text-sm md:text-base font-semibold text-slate-300 mb-1.5 sm:mb-2">
            Nombre de la bodega
          </label>
          <input
            required
            type="text"
            className="w-full px-3 sm:px-3.5 md:px-4 lg:px-5 py-2.5 sm:py-2.5 md:py-3 lg:py-3.5 text-sm sm:text-base rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 touch-target"
            style={{
        ...
        <div className="w-full">
          ...
          <select
            className="w-full px-3 sm:px-4 md:px-5 py-2.5 sm:py-3 md:py-3.5 text-sm sm:text-base rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 touch-target appearance-none"
            style={{
              backgroundColor: '#1e293b',
              border: '1px solid #334155',
              color: '#f1f5f9'
        ...
        <div className="rounded-lg p-3 sm:p-4 md:p-4 lg:p-5 border w-full" style={{
        ...
        <div className="rounded-lg p-3 sm:p-3.5 md:p-4 lg:p-5 border mt-2 sm:mt-3 w-full" style={{
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
            ...
            <div className="flex items-center bg-slate-800 rounded-lg p-0.5 sm:p-1 w-full sm:w-auto">
              <button
                type="button"
                onClick={() => setBodegaForm({ ...bodegaForm, estatus: true })}
                className="flex-1 sm:flex-none flex items-center justify-center gap-0.5 sm:gap-1 md:gap-2 px-1.5 sm:px-2 md:px-4 py-1 sm:py-1.5 md:py-2 text-xs sm:text-sm md:text-base font-medium rounded transition-all duration-200 touch-target hover:text-slate-200 hover:bg-slate-700/30"
                style={{
                  border: 'none',
                  cursor: 'pointer',
                  backgroundColor: bodegaForm?.estatus ? '#1037b9ff' : 'transparent',
              ...
              >
                <XCircleIcon className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5" />
                <span className="hidden xs:inline">Inactivo</span>
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-2.5 md:gap-3 lg:gap-4 pt-3 sm:pt-4 border-t w-full" style={{ borderColor: '#1e293b' }}>
          <button
            type="button"
            onClick={onClose}
            className="px-4 sm:px-5 md:px-6 lg:px-8 py-2.5 sm:py-2.5 md:py-3 text-sm sm:text-base font-medium rounded-lg border transition-all duration-200 touch-target hover:bg-slate-800"
            style={{
              borderColor: '#334155',
              color: '#cbd5e1',
          ...
          <button
            ...
            className="px-4 sm:px-6 md:px-8 lg:px-10 py-2.5 sm:py-2.5 md:py-3 text-white text-sm sm:text-base font-semibold rounded-lg transition-all duration-200 touch-target disabled:opacity-60 disabled:cursor-not-allowed hover:scale-[1.02] hover:shadow-lg"
            style={{
