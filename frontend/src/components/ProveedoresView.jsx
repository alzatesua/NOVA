        ...
        {loading ? (
          ...
          <div className="bg-white dark:!bg-slate-900 rounded-lg shadow-sm p-6 ring-1 ring-slate-200 dark:!ring-slate-700">
            ...
            <div className="flex items-start justify-between mb-6 pb-6 border-b border-gray-200 dark:!border-slate-700">
              ...
              <div className="flex gap-2">
                <button className="flex items-center gap-2 px-4 py-2 border border-gray-300 dark:!border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:!bg-slate-800 transition-colors dark:!text-white">
                  <Edit size={18} strokeWidth={2} />
                  <span>Editar</span>
                </button>
                <button className="flex items-center gap-2 px-4 py-2 text-red-600 border border-red-300 rounded-lg hover:bg-red-50 dark:hover:!bg-red-900/20 transition-colors">
            ...
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:!text-white mb-3">
                Productos ({proveedorSeleccionado.total_productos || 0})
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
