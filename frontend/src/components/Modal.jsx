...
export default function Modal({ children, onClose }) {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 px-0 sm:px-4"
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      >
        ...
        {/* Contenido */}
        <div className="relative z-10 p-2 sm:p-3 md:p-4 lg:p-6 h-full sm:h-auto overflow-y-auto">
          {children}
        </div>
      </div>
    </div>,
